...
class SQLALCHAMYHandler(logging.Handler):
    ...
    def __init__(self):
        ...
        log_models.Base.metadata.create_all(bind=database.engine)
    ...
    def emit(self, record):
        ...
        f = OneLineExceptionFormatter(self.LOG_FORMAT, self.LOG_DATE_FORMAT)
        if record.exc_info:
        ...
        print(log_data)
        log = self.ProcessLogModel(
            created_timestamp=log_data["dbtime"],
